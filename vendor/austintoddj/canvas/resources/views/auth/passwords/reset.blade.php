...
@section('content')
    <main class="col-12 col-lg-5">
        <div class="mb-5 text-center">
            <h1>Por favor <span class="font-cursive">configura</span> tu password</h1>
        </div>
        <div class="card shadow-lg w-auto">
            <div class="card-body">
                <form method="POST" action="{{ route('canvas.password.update') }}" class="w-100 my-auto">
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            <label for="password_confirmation" class="font-weight-bold text-uppercase text-muted small"> Confirma tu password </label>
                            <input
                                type="password"
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            <button class="btn btn-success btn-block mt-3" type="submit">Resetear password</button>
                        </div>
                    </div>
                </form>
            </div>
