			...
			<div class="custompad row flex-lg-row-reverse align-items-center g-5 py-5">
				...
				<div class="col-lg-6">
					...
					<div class="d-grid gap-2 d-md-flex justify-content-md-start">
						...
						<!-- <router-link to="/foo" tag="button"  class="btn custombotto1 btn-lg px-4 me-md-2 fw-bold">
							Contacto
						</router-link> -->

						<router-link to="/foo" tag="button"  class="btn  custombotto2 btn-lg px-4 me-md-2 fw-bold">
							Blog
						</router-link>
