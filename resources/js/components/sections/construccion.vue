<template>
	<!-- Esta seccion de llama contrucion2 en la version de laravel -->
         ...
         <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
           <div class="carousel-inner">
             <div class="carousel-item active" data-bs-interval="3000">
               ...
               <img src="/images/MSArquitecta contruccion  carrusel 1.jpg" class="img-right"/>
             </div>
             <div class="carousel-item" data-bs-interval="5000">

               <img src="/images/MSArquitecta contruccion  carrusel 2.jpg" class="img-left"/>
             </div>
             <div class="carousel-item" data-bs-interval="5000">
               <img src="/images/MSArquitecta contruccion  carrusel 3.jpg" class="img-left"/>
             </div>
             <div class="carousel-item" data-bs-interval="5000">
               <img src="/images/MSArquitecta contruccion  carrusel 4.jpg" class="img-left"/>
             </div>
           </div>
         </div>
      </div>
